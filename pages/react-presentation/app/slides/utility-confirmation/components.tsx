...
export const Step1 = observer(({ handleProvider, handleTariff }) => {
  ...
  return (
    <div className="selection-content">
      <p className="selection-header">MAKE YOUR SELECTION</p>
      <h2 className="selection-title">Your utility company & type</h2>
...
export const Step2 = observer(({handleGeneric}) => {
  ...
  return (
    <div className="selection-content">
      <p className="selection-header">INPUT INFORMATION</p>
      <h2 className="selection-title">
        Add your monthly consumption information (kWh)
      </h2>
      <div className="input-grid">
        {months.map((month) => (
          <div className="input-group" key={month.field}>
            <label className="input-label" htmlFor={month.field}>
              {month.text}
            </label>
            <input
              type="text"
      ...
      <div className="review-content">
        <div className="information-section">
          ...
          <div className="timeline">
            ...
            <div className="info-item">
              <p className="info-label">UTILITY TARIFF</p>
              <p className="info-value">
                {selectedTariffObj ? selectedTariffObj.label : 'Not selected'}
              </p>
            </div>
            <div className="info-item">
              <p className="info-label">AVERAGE MONTHLY USAGE</p>
              <p className="info-value">
        ...
        <div className="summary-section">
          <div className="info-item-no-dot">
            <p className="d1-semi gray">Your Average Daily Spend</p>
            <p className="dollar-amount">${averageDailySpend.toFixed(2)}</p>
          </div>
          <div className="info-item-no-dot">
            <p className="d1-semi gray">Your Average Monthly Bill</p>
            <p className="dollar-amount">
...
export const Step4 = observer(() => {
  ...
  const setStep = (step: number) => $state.step.set(step);

  const chartOptions: ChartOptions<'line'> = generateChart($state) as any;

  return (
    <div className="selection-content">
      <div className="gear-icon" onClick={() => setStep(3)}>
        ⚙️
      </div>
