...
import sty from "./PlasmicPageLayout.module.css"; // plasmic-import: Cl1YL8qlLped/css

import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: ZOSPnHvCUGx_/icon
import Icon2Icon from "./icons/PlasmicIcon__Icon2"; // plasmic-import: TmQYRVW8iDlZ/icon
...
function PlasmicPageLayout__RenderFunc(props: {
  ...
  return (
    <RichLayout
      ...
      logoElement={
        <Icon2Icon
          className={classNames(projectcss.all, sty.svg__xjnMg)}
          role={"img"}
        />
      }
      navMenuItems={(() => {
    ...
    >
      <LoadingBoundary
        ...
        loadingState={
          <DataCtxReader__>
            {$ctx => (
              <div className={classNames(projectcss.all, sty.freeBox___0PSg)}>
                <IconIcon
                  className={classNames(projectcss.all, sty.svg___8RBUp)}
                  role={"img"}
                />
              </div>
            )}
