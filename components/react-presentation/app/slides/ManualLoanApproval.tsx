  ...
  return (
    <div className="mla-manual-loan-approval-container">
      ...
      <div className="mla-manual-loan-approval-right-column">
        <h1 className="mla-manual-loan-approval-title h1-semi fade-in heading">
        ...
        <div className="mla-manual-loan-approval-section">
          <div className="mla-manual-loan-approval-grid">
            <div className="mla-manual-loan-details">
              ...
              <input
                className={`mla-manual-loan-approval-input ${
            ...
            <div className="mla-manual-applicant-details">
              <h2 className="manual-loan-approval-subtitle">
                Primary Applicant
              </h2>
        ...
        <button
          className="mla-manual-loan-approval-button"
      ...
      {showConfirmModal && (
        <div className="mla-manual-loan-approval-modal">
          <div className="mla-manual-loan-approval-modal-content">
            <h2 className="mla-manual-loan-approval-subtitle">
              Confirm Submission
            </h2>
            <p>Are you sure you want to submit this loan approval?</p>
            <div className="mla-manual-loan-approval-modal-buttons">
              <button
                className="mla-manual-loan-approval-button"
